...
Therefore, the research objective of this paper is to design a neural network that takes $\{Q_i\}_{i=1}^N$ as input and outputs $Q_{tot}$, while enforcing the monotonicity constraint in Equation$`(3)`$. 
