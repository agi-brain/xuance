...
The common tools serve to prepare the DRL model before training, such as loading hyper-parameters from YAML files, 
obtaining terminal commands, and creating a pre-defined runner for DRL implementations.
