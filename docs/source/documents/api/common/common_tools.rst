...
.. py:function::
  ...
  :param basic_dict: xxxxxx.
  :type basic_dict: xxxxxx
  :param target_dict: xxxxxx.
  :type target_dict: xxxxxx
  :return: xxxxxx.
  :rtype: xxxxxx

.. py:function::
  xuance.common.common_tools.get_config(file_name)

  xxxxxx.

  :param file_name: xxxxxx.
  :type file_name: xxxxxx
  :return: xxxxxx.
  :rtype: xxxxxx

.. py:function::
  xuance.common.common_tools.get_arguments(method, env, env_id, config_path, parser_args)
  ...
  :param env_id: xxxxxx.
  :type env_id: xxxxxx
  :param config_path: xxxxxx.
  :type config_path: xxxxxx
  :param parser_args: xxxxxx.
  :type parser_args: xxxxxx
  :return: xxxxxx.
  :rtype: xxxxxx

.. py:function::
  xuance.common.common_tools.get_runner(method, env, env_id, config_path, parser_args, is_test)
  ...
  :param parser_args: xxxxxx.
  :type parser_args: xxxxxx
  :param is_test: xxxxxx.
  :type is_test: xxxxxx
  :return: xxxxxx.
  :rtype: xxxxxx

.. py:function::
  xuance.common.common_tools.get_runner(path)
...
.. py:function::
  xuance.common.common_tools.space2shape(observation_space, Space)
...
.. py:function::
  xuance.common.common_tools.dict_reshape(keys, dict_list)

  xxxxxx.

  :param keys: xxxxxx.
  :type keys: xxxxxx
  :param dict_list: xxxxxx.
  :type dict_list: xxxxxx
  :return: xxxxxx.
  :rtype: xxxxxx
...
.. py:function::
  xuance.common.common_tools.merge_iterators(*iters)
