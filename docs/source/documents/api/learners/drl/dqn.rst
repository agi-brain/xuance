...
.. py:class::
  xuance.tensorflow.learners.qlearning_family.dqn_learner.DQN_Learner(policy, optimizer, device, model_dir, gamma, sync_frequency)
...
.. py:function::
  xuance.tensorflow.learners.qlearning_family.dqn_learner.DQN_Learner.update(obs_batch, act_batch, rew_batch, next_batch, terminal_batch)
...
.. py:class::
  xuance.mindspore.learners.qlearning_family.dqn_learner.DQN_Learner(policy, optimizer, scheduler, model_dir, gamma, sync_frequency)
...
.. py:function::
  xuance.mindspore.learners.qlearning_family.dqn_learner.DQN_Learner.update(obs_batch, act_batch, rew_batch, next_batch, terminal_batch)
