...
.. py:class::
  xuance.tensorflow.learners.policy_gradient.pdqn_learner.PDQN_Learner(policy, optimizer, device, model_dir, gamma, tau)
...
.. py:class::
  xuance.mindspore.learners.policy_gradient.pdqn_learner.PDQN_Learner(policy, optimizer, scheduler, model_dir, gamma, tau)
