...
.. py:class::
  xuance.torch.learners.qlearning_family.spdqn_learner.SPDQN_Learner(policy, optimizer, scheduler, device, model_dir, gamma, tau)
...
.. py:function::
  xuance.torch.learners.qlearning_family.spdqn_learner.SPDQN_Learner.update(obs_batch, act_batch, rew_batch, next_batch, terminal_batch)
