...
.. py:class::
    xuance.tensorflow.agent.qlearning_family.qrdqn_agent.QRDQN_Agent(config, envs, policy, optimizer, device)
...
.. py:function::
    xuance.tensorflow.agent.qlearning_family.qrdqn_agent.QRDQN_Agent._action(obs, egreedy)
...
.. py:function::
    xuance.tensorflow.agent.qlearning_family.qrdqn_agent.QRDQN_Agent.train(train_steps)
...
.. py:function::
    xuance.tensorflow.agent.qlearning_family.qrdqn_agent.QRDQN_Agent.test(env_fn, test_episodes)
...
.. py:class::
    xuance.mindspore.agents.qlearning_family.qrdqn_agent.QRDQN_Agent(config, envs, policy, optimizer, scheduler)
            ...
            class QRDQN_Agent(Agent):
                def __init__(self,
                    ...
                    learner = QRDQN_Learner(policy,
                                            ...
                                            config.gamma,
                                            config.sync_frequency)
                    super(QRDQN_Agent, self).__init__(config, envs, policy, memory, learner, device, config.log_dir, config.model_dir)
            ...
            class QRDQN_Agent(Agent):
                def __init__(self,
                    ...
                    learner = QRDQN_Learner(policy,
                                            ...
                                            config.gamma,
                                            config.sync_frequency)
                    super(QRDQN_Agent, self).__init__(config, envs, policy, memory, learner, config.log_dir, config.model_dir)
