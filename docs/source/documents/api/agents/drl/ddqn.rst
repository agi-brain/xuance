...
.. py:function::
    xuance.tensorflow.agent.qlearning_family.ddqn_agent.DDQN_Agent._action(obs, egreedy)
...
.. py:function::
    xuance.tensorflow.agent.qlearning_family.ddqn_agent.DDQN_Agent.train(train_steps)
...
.. py:function::
    xuance.tensorflow.agent.qlearning_family.ddqn_agent.DDQN_Agent.test(env_fn, test_episodes)
            ...
            class DDQN_Agent(Agent):
                def __init__(self,
                    ...
                    learner = DDQN_Learner(policy,
                                           ...
                                           config.gamma,
                                           config.sync_frequency)
                    super(DDQN_Agent, self).__init__(config, envs, policy, memory, learner, device, config.log_dir, config.model_dir)
