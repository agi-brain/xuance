...
.. py:class::
    xuance.tensorflow.agent.qlearning_family.dueldqn_agent.DuelDQN_Agent(config, envs, policy, optimizer, device)
...
.. py:function::
    xuance.tensorflow.agent.qlearning_family.dueldqn_agent.DuelDQN_Agent._action(obs, egreedy)
...
.. py:function::
    xuance.tensorflow.agent.qlearning_family.dueldqn_agent.DuelDQN_Agent.train(train_steps)
...
.. py:function::
    xuance.tensorflow.agent.qlearning_family.dueldqn_agent.DuelDQN_Agent.test(env_fn, test_episodes)
...
.. py:class::
    xuance.mindspore.agents.qlearning_family.dueldqn_agent.DuelDQN_Agent(config, envs, policy, optimizer, scheduler)
...
.. py:function::
    xuance.mindspore.agents.qlearning_family.dueldqn_agent.DuelDQN_Agent._action(obs, egreedy)
...
.. py:function::
    xuance.mindspore.agents.qlearning_family.dueldqn_agent.DuelDQN_Agent.train(train_steps)

    :param train_steps: The number of steps for training.
    :type train_steps: int

.. py:function::
    xuance.mindspore.agents.qlearning_family.dueldqn_agent.DuelDQN_Agent.test(env_fn,test_episodes)
        ...
        .. code-block:: python
            ...
            class DuelDQN_Agent(Agent):
                ...
                def __init__(self,
                    ...
                    super(DuelDQN_Agent, self).__init__(config, envs, policy, memory, learner, device,
            ...
            class DuelDQN_Agent(Agent):
                def __init__(self,
                    ...
                    learner = DuelDQN_Learner(policy,
                                              ...
                                              config.gamma,
                                              config.sync_frequency)
                    super(DuelDQN_Agent, self).__init__(config, envs, policy, memory, learner, device, config.log_dir, config.model_dir)
