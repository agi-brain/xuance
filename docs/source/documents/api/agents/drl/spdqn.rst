...
.. py:class::
    xuance.tensorflow.agent.policy_gradient.spdqn_agent.SPDQN_Agent(config, envs, policy, optimizer, device)
...
.. py:function::
    xuance.tensorflow.agent.policy_gradient.spdqn_agent.SPDQN_Agent._action(obs)
...
.. py:function::
    xuance.tensorflow.agent.policy_gradient.spdqn_agent.SPDQN_Agent.pad_action(disaction, conaction)
...
.. py:function::
    xuance.tensorflow.agent.policy_gradient.spdqn_agent.SPDQN_Agent.train(train_steps)
...
.. py:function::
    xuance.tensorflow.agent.policy_gradient.spdqn_agent.SPDQN_Agent.test(env_fn, test_episodes)
...
.. py:class::
    xuance.mindspore.agents.policy_gradient.spdqn_agent.SPDQN_Agent(config, envs, policy, optimizer, scheduler)
...
.. py:function::
    xuance.mindspore.agents.policy_gradient.spdqn_agent.SPDQN_Agent._action(obs)
