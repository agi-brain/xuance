...
.. py:function::
    xuance.tensorflow.agent.qlearning_family.perdqn_agent.PerDQN_Agent._action(obs, egreedy)
...
.. py:function::
    xuance.tensorflow.agent.qlearning_family.perdqn_agent.PerDQN_Agent.train(train_steps)
...
.. py:function::
    xuance.tensorflow.agent.qlearning_family.perdqn_agent.PerDQN_Agent.test(env_fn, test_episodes)
