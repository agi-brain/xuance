...
.. py:function:: 
    xuance.torch.agent.qlearning_family.noisydqn_agent.NoisyDQN_Agent._action(obs)
...
.. py:class::
    xuance.tensorflow.agent.qlearning_family.noisydqn_agent.NoisyDQN_Agent(config, envs, policy, optimizer, device)
...
.. py:function::
    xuance.tensorflow.agent.qlearning_family.noisydqn_agent.NoisyDQN_Agent._action(obs)
...
.. py:function::
    xuance.tensorflow.agent.qlearning_family.noisydqn_agent.NoisyDQN_Agent.train(train_steps)
...
.. py:function::
    xuance.tensorflow.agent.qlearning_family.noisydqn_agent.NoisyDQN_Agent.test(env_fn, test_episodes)
...
.. py:class::
    xuance.mindspore.agents.qlearning_family.noisydqn_agent.NoisyDQN_Agent(config, envs, policy, optimizer, scheduler)
...
.. py:function::
    xuance.mindspore.agents.qlearning_family.noisydqn_agent.NoisyDQN_Agent._action(obs)
