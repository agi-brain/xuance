...
.. py:function::
    xuance.tensorflow.agent.mutli_agent_rl.qtran_agents.QTRAN_Agents.act(obs_n, *rnn_hidden, avail_actions, test_mode)
...
.. py:function::
    xuance.tensorflow.agent.mutli_agent_rl.qtran_agents.QTRAN_Agents.train(i_step, n_epoch)
