...
.. py:function::
    xuance.tensorflow.agent.mutli_agent_rl.vdn_agents.VDN_Agents.act(obs_n, *rnn_hidden, avail_actions=None, test_mode=False)
        ...
        .. code-block:: python
            ...
            class VDN_Agents(MARLAgents):
                def __init__(self,
                    ...
                    learner = VDN_Learner(config, policy, optimizer,
        ...
        .. code-block:: python
            ...
            class VDN_Agents(MARLAgents):
                def __init__(self,
                    ...
                    super(VDN_Agents, self).__init__(config, envs, policy, memory, learner, config.log_dir, config.model_dir)
                    self.on_policy = False
