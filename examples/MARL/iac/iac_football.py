...
def parse_args():
    parser = argparse.ArgumentParser("Example: IAC of XuanCe for Football environments.")
...
if __name__ == "__main__":
    parser = parse_args()
    configs_dict = load_yaml(file_dir=f"iac_football_configs/{parser.env_id}.yaml")
