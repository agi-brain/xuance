...
def parse_args():
    parser = argparse.ArgumentParser("Example: DCG of XuanCe for Football environments.")
...
class RunnerFootball:
    def __init__(self, config):
        ...
        self.agents = DCG_Agents(config=config, envs=self.envs)  # Create the Independent PPO agents.
        self.config = config
...
if __name__ == "__main__":
    parser = parse_args()
    configs_dict = get_configs(file_dir=f"dcg_football_configs/{parser.env_id}.yaml")
