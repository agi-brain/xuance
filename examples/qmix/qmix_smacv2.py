...
def parse_args():
    parser = argparse.ArgumentParser("Example: QMIX of XuanCe for SMACv2 environments.")
...
class RunnerSMACv2:
    def __init__(self, config):
        ...
        self.agents = QMIX_Agents(config=config, envs=self.envs)
        self.config = config
...
if __name__ == "__main__":
    ...
    config_path = os.path.join(script_dir, f"qmix_smacv2_configs/{parser.config}.yaml")
