...
def parse_args():
    parser = argparse.ArgumentParser("Example of XuanCe: IDDPG for MPE.")
...
if __name__ == "__main__":
    parser = parse_args()
    configs_dict = get_configs(file_dir=f"iddpg_mpe_configs/{parser.env_id}.yaml")
    ...
    Agent = IDDPG_Agents(config=configs, envs=envs)
