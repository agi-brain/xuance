...
def parse_args():
    parser = argparse.ArgumentParser("Example: IC3Net of XuanCe for SMAC environments.")
...
if __name__ == "__main__":
    parser = parse_args()
    configs_dict = get_configs(file_dir=f"ic3net_sc2_configs/{parser.env_id}.yaml")
