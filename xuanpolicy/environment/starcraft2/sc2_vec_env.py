...
from ..vector_envs.subproc_vec_env import clear_mpi_env_vars, flatten_list, flatten_obs, CloudpickleWrapper
from ..vector_envs.vector_env import VecEnv


class VecEnv_StarCraft2(VecEnv):
    def __init__(self, env_fns):
        super(VecEnv_StarCraft2, self).__init__(env_fns, spaces=None, in_series=len(env_fns))
