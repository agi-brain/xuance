...
from xuanpolicy.environment import magent2
from xuanpolicy.environment.magent2.environments.battle.battle import KILL_REWARD, get_config
from xuanpolicy.environment.magent2.environments.magent_env import magent_parallel_env, make_env
