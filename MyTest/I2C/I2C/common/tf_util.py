...
class BatchInput(PlacholderTfInput):
    def __init__(self, shape, batch_size=None, dtype=tf.float32, name=None):
        ...
        """
        super().__init__(tf.placeholder(dtype, [batch_size] + list(shape), name=name))
...
def make_session_cpu(num_cpu=4):
