...
def parse_args():
    parser = argparse.ArgumentParser("Example of XuanCe: QMIX.")
    ...
    parser.add_argument("--config", type=str, default="./configs/mpe_Qmix_test.yaml")
...
class Runner(object):
    def __init__(self, args):
        ...
        self.args.dim_act = self.envs.action_space[self.agent_keys[0]].n
        ...
        self.agents = QMIX_Agents(self.args, self.envs, self.args.device)
