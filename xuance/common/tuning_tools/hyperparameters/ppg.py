...
ppg_hyperparams = [
    ...
    Hyperparameter(
        name="policy_nepoch",  # The number of epochs for policy update.
        type="int",
        distribution=[1, 4, 8, 16],
        log=False,
        default=4
    ...
    Hyperparameter(
        name="value_nepoch",  # The number of epochs for .
        type="int",
        distribution=[1, 4, 8, 16],
        log=False,
        default=8
    ...
    Hyperparameter(
        name="aux_nepoch",  # The number of epochs for auxiliary training epochs.
        type="int",
        distribution=[1, 4, 8, 16],
        log=False,
        default=8
    ...
    Hyperparameter(
        name="kl_beta",  # The weight of KL loss.
        type="float",
