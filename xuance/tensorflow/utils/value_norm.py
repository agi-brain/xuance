...
class ValueNorm(nn.Module):
    ...
    def update(self, input_vector):
        with tf.no_gradient:
            if type(input_vector) == np.ndarray:
                input_vector = tf.from_numpy(input_vector)
    ...
    def normalize(self, input_vector):
        ...
        out = (input_vector - mean[(None,) * self.norm_axes]) / tf.sqrt(var)[(None,) * self.norm_axes]
    ...
    def denormalize(self, input_vector):
        ...
        mean, var = self.running_mean_var()
        out = input_vector * tf.sqrt(var)[(None,) * self.norm_axes] + mean[(None,) * self.norm_axes]
