...
from xuance.common import List, SequentialReplayBuffer, BaseCallback
...
class DreamerV2Agent(OffPolicyAgent):
    def __init__(
        ...
        super(DreamerV2Agent, self).__init__(config, envs, observation_space, action_space, callback)
