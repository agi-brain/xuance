...
class IPPO_Agents(MARLAgents):
    ...
    def run_episodes(self, env_fn=None, n_episodes: int = 1, test_mode: bool = False):
        ...
        while episode_count < n_episodes:
            step_info = {}
            rnn_hidden_actor, rnn_hidden_critic, actions_dict, log_pi_a_dict, values_dict = self.action(
                obs_dict=obs_dict, avail_actions_dict=avail_actions,
                rnn_hidden_actor=rnn_hidden_actor, rnn_hidden_critic=rnn_hidden_critic, test_mode=test_mode)
