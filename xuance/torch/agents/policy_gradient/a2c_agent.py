...
class A2C_Agent(Agent):
    ...
    def _build_policy(self):
        ...
        if self.config.representation == "Basic_Identical":
            ...
            raise AttributeError(f"A2C currently does not support {self.config.representation} representation.")
